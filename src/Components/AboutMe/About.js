  ...
  return (
    <div className="information-container">
      <div className='about-container'>
        <p>Hello!</p>
        <p>My name is Fabian Villaseñor, a Front End Web Developer. I began coding when I found a FREE coding academy teaching web development using Angular in my hometown of Modesto, California.
